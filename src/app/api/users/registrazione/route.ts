...
const schemaAtleta = z.object({
  ...
  sport: z.array(z.enum(['calcio', 'pallavolo', 'basket', 'calcio5', 'padel'])).min(1, 'Seleziona almeno uno sport'),
  sportPrimario: z.enum(['calcio', 'pallavolo', 'basket', 'calcio5', 'padel'], { errorMap: () => ({ message: 'Sport primario obbligatorio' }) }),
...
const schemaSocieta = z.object({
  ...
  sport: z.array(z.enum(['calcio', 'pallavolo', 'basket', 'calcio5', 'padel'])).min(1),
  sportPrimario: z.enum(['calcio', 'pallavolo', 'basket', 'calcio5', 'padel']),
